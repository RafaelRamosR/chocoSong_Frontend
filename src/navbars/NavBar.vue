        ...
        <div class=" z-50 bg-black-100 shadow-xl fixed w-56 rounded-r-xl">
            <div class="my-10 mx-4">
                <div class="text-gray-300 relative min-h-screen">
                    ...
                    <NavBarLinks :url="{name:'login'}" v-if="!datos.id">
                            <template #icon>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <NavBarLinks :url="{name:'register'}" v-if="!datos.id">
                            <template #icon>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <NavBarLinks :url="{name:'about'}" v-if="!datos.id">
                            <template #icon>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
<!-- ---------------------------------------------------------LINKS USERS AUTHENTICATED--------------------------------- -->
                    <NavBarLinks :url="{name:'dashboard'}" v-if="datos.id">
                            <template #icon>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                                </svg>
                    ...
                    <NavBarLinks v-if="datos.id && datos.rol_id>0" :url="{name:'home'}" class="absolute bottom-14" @click="logout()">
                            <template #icon>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
